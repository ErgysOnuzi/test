                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mb-2">
                        <a href="tel:+49308832156" className="text-primary hover:text-primary/80 transition-colors text-lg font-medium">
                          030 8832156
                        </a>
                      </p>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <div className="text-muted-foreground space-y-1">
                        ...
                        <div className="flex justify-between">
                          <span>{t('sunday')}</span>
                          <span className="font-medium">{t('sunday_hours')}</span>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-8 bg-card/30 backdrop-blur-sm rounded-3xl border border-border hover:shadow-xl transition-all duration-300 hover:scale-105">
                ...
                <h3 className="text-xl font-serif font-bold text-foreground mb-4">{t('authentic_experience')}</h3>
                <p className="text-muted-foreground">
              ...
              <div className="text-center p-8 bg-card/30 backdrop-blur-sm rounded-3xl border border-border hover:shadow-xl transition-all duration-300 hover:scale-105">
                ...
                <h3 className="text-xl font-serif font-bold text-foreground mb-4">{t('perfect_atmosphere')}</h3>
                <p className="text-muted-foreground">
