                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          <div className="flex items-center gap-2 text-sm">
                            ...
                            <div>
                              ...
                              <p className="text-muted-foreground text-xs">{t('date_label')}</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-2 text-sm">
                            ...
                            <div>
                              ...
                              <p className="text-muted-foreground text-xs">{t('time_label')}</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-2 text-sm">
                            ...
                            <div>
                              <p className="font-semibold text-foreground">{event.capacity} {t('people')}</p>
                              <p className="text-muted-foreground text-xs">{t('capacity_label')}</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-2 text-sm">
                            ...
                            <div>
                              ...
                              <p className="text-muted-foreground text-xs">{t('per_person')}</p>
                            </div>
                          </div>
                        </div>
