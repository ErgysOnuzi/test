  ...
  try {
    ...
    if (response.ok) {
      ...
      event = {
        ...
        longDescription: dbEvent.description || 'Join us for this special event at Ristorante La Cantina Bleibtreu. More details will be provided upon booking.',
        longDescription_de: dbEvent.description || 'Begleiten Sie uns zu dieser besonderen Veranstaltung im Ristorante La Cantina Bleibtreu. Weitere Details erhalten Sie bei der Buchung.',
        date: dbEvent.date,
        time: '19:00',
        duration: '3 hours',
              ...
              <div className="bg-card/50 backdrop-blur-sm rounded-2xl p-6 border border-border">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="font-medium">Ristorante La Cantina Bleibtreu</p>
