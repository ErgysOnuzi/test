  ...
  de: [
    {
      ...
      excerpt:
        'Lernen Sie die Geheimnisse unserer Pasta-Meister kennen. Von der Auswahl des richtigen Mehls bis zur perfekten Textur.',
      content:
        'Authentische italienische Pasta beginnt mit den besten Zutaten...',
    ...
    },
    {
      ...
      excerpt:
        'Entdecken Sie, wie sizilianische Weine unsere traditionellen Gerichte perfekt ergänzen.',
    ...
    },
    {
      ...
      excerpt:
        'Von den ersten italienischen Immigranten bis zur modernen Gastronomieszene Berlins.',
  ...
  en: [
    {
      ...
      excerpt:
        'Learn the secrets of our pasta masters. From choosing the right flour to achieving perfect texture.',
    ...
    },
    {
      ...
      excerpt:
        'Discover how Sicilian wines perfectly complement our traditional dishes.',
    ...
    },
    {
      ...
      excerpt:
        "From the first Italian immigrants to Berlin's modern gastronomic scene.",
                  ...
                  <div className='flex items-center justify-between text-sm text-muted-foreground mb-4'>
                    <div className='flex items-center gap-4'>
                      <div className='flex items-center gap-1'>
                        ...
                        <span>
                          {translations.by} {post.author}
                        </span>
                      </div>
                      <div className='flex items-center gap-1'>
                        <Clock className='w-4 h-4' />
                        <span>
                          {post.readTime} {translations.minRead}
                        </span>
                      </div>
                    </div>
                  </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
            <div className='bg-card rounded-2xl p-6 text-center hover:shadow-lg transition-shadow'>
              ...
              <p className='text-muted-foreground'>
                {locale === 'de'
                  ? 'Professionelle Kochtipps direkt aus unserer Küche'
                  : 'Professional cooking tips straight from our kitchen'}
              </p>
            </div>
            ...
            <div className='bg-card rounded-2xl p-6 text-center hover:shadow-lg transition-shadow'>
              ...
              <p className='text-muted-foreground'>
                {locale === 'de'
                  ? 'Weinwissen und perfekte Paarungen für italienische Gerichte'
                  : 'Wine knowledge and perfect pairings for Italian dishes'}
              </p>
            </div>
            ...
            <div className='bg-card rounded-2xl p-6 text-center hover:shadow-lg transition-shadow'>
              ...
              <p className='text-muted-foreground'>
                {locale === 'de'
                  ? 'Geschichten über italienische Traditionen und Kultur'
                  : 'Stories about Italian traditions and culture'}
              </p>
            </div>
          </div>
        </div>
