        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
                ...
                <Link key={index} href={card.href} className='group'>
                  <div className='bg-card rounded-xl border border-border p-8 hover:shadow-lg transition-all duration-200 hover-elevate'>
                    <div className='flex items-start gap-6'>
                      <div
                        className={`w-16 h-16 ${card.color} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform`}
                      >
          ...
          <div className='mt-12'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4'>
              <Link
                href={`/${locale}/admin/menu`}
                className='bg-card rounded-lg border border-border p-4 hover-elevate transition-all'
              >
