    ...
    try {
      ...
      if (response.ok) {
        setFeedbacks((prev) =>
          prev.map((feedback) =>
            feedback.id === id
              ? { ...feedback, isPublic: !currentVisibility }
              : feedback
          )
        );
        setSuccessMessage(
          !currentVisibility ? t('feedback_made_visible') : t('feedback_hidden')
        );
        setError(null);
        setTimeout(() => setSuccessMessage(null), 5000);
      } else {
                  ...
                  >
                    <div className='flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4'>
                      ...
                      <div className='flex lg:flex-col gap-2'>
                        {feedback.status === 'pending' && (
                          <>
                            <button
                              ...
                              disabled={
                                actionLoading[feedback.id] === 'approved'
                              }
                            ...
                            <button
                              ...
                              disabled={
                                actionLoading[feedback.id] === 'rejected'
                              }
                        ...
                        <button
                          onClick={() =>
                            toggleVisibility(feedback.id, feedback.isPublic)
                          }
                          disabled={
                        ...
                        >
                          ...
                          {actionLoading[feedback.id] === 'delete'
                            ? 'Deleting...'
                            : 'Delete'}
                        </button>
                      </div>
