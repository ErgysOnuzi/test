      ...
      <div className="min-h-screen bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-4xl font-serif font-bold text-primary mb-2">{t('events_management_title')}</h1>
              <p className="text-muted-foreground text-lg">{t('events_management_desc')}</p>
            </div>
            <Link 
              href={`/${locale}/admin`} 
