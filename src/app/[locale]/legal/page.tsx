      ...
      <div className='max-w-4xl mx-auto'>
        ...
        <section className='mb-12'>
          ...
          <div className='bg-white rounded-lg shadow-sm border p-8'>
            ...
            <p className='mb-4'>{t('managing_director')}</p>
            ...
            <p className='mb-4'>
              {t('registration_entry')}
              <br />
              {t('registration_court')}
              <br />
        ...
        <section>
          ...
          <div className='bg-white rounded-lg shadow-sm border p-8'>
            <h3 className='font-semibold mb-3'>
              {t('privacy_overview_heading')}
            </h3>
            <p className='mb-4'>{t('privacy_overview_text')}</p>

            <h3 className='font-semibold mb-3'>
              {t('responsible_party_heading')}
            </h3>
            <p className='mb-4'>
              {t('responsible_for_data')}
              <br />
              {t('company_name')}
              <br />
              {t('company_address')}
            ...
            <p className='mb-4'>{t('data_collection_text')}</p>

            <h3 className='font-semibold mb-3'>{t('forms_data_heading')}</h3>
            <p className='mb-4'>{t('forms_data_text')}</p>
