  ...
  de: {
    ...
    pages: {
      menu: {
        ...
        noItems: 'Keine Gerichte verfügbar',
        filterByCategory: 'Nach Kategorie filtern',
        allCategories: 'Alle Kategorien',
        searchPlaceholder: 'Gerichte suchen...',
        priceRange: 'Preisbereich',
        dietaryOptions: 'Ernährungsoptionen',
      ...
      events: {
        ...
        limitedSeating: 'Begrenzte Plätze',
      ...
      reservations: {
        ...
        validation: {
          ...
          guestsRequired: 'Anzahl Gäste ist erforderlich'
        },
    ...
    instagram: {
      ...
      followUs: 'Folgen Sie uns für weitere Updates',
      loadingPosts: 'Beiträge werden geladen...',
      errorLoading: 'Instagram-Beiträge konnten nicht geladen werden',
      noPosts: 'Keine Instagram-Beiträge verfügbar',
      refreshPosts: 'Beiträge aktualisieren'
    },
...
export function getTranslation(locale: Locale, keyPath: string): string {
  ...
  let current: any = translations[locale] || translations.de;
